...
VSN_F104G =  {
		...
		Name 			= 'VSN_F104G',--AG
		DisplayName		= _('F-104G Starfighter'),--AG
        Picture 		= "VSN_F104G.png",
        Rate 			= "50",
        Shape			= "VSN_F104G",--AG	
	...
	Categories= {"{78EFB7A2-FD52-4b57-A6A6-3BF0E1D6555F}", "Interceptor",},
		...
		M_nominal					=	8994,	-- kg (Empty Plus Full Internal Fuel) F104 changed
		M_max						=	13170,	-- kg (Maximum Take Off Weight) F104 changed
		M_fuel_max					=	2644,	-- kg (Internal Fuel Only) F104 changed
...
--1 × sechsläufige 20-mm-Gatling-Maschinenkanone General Electric T171 (M61) Vulcan mit 725 Schuss Munition
	...
	Pylons =     {
        ...
        pylon(2, 0, -1.200, 0.000, -3.47000,
		 ...
		 pylon(4, 0, -0.800, -0.310, -1.900,
            ...
            },
            {
				...
				{ CLSID = "{F72F47E5-C83A-4B85-96ED-D3E46671EE9A}" ,arg_value = 0.0},--B-8M1 - 20 S-8KOM
				{ CLSID = "{3858707D-F5D5-4bbb-BDD8-ABB0530EBC7C}" ,arg_value = 0.0},--S-24B	
				{ CLSID = "B-8M1 - 20 S-8OFP2"					   ,arg_value = 0.0},
				{ CLSID = "{3DFB7320-AB0E-11d7-9897-000476191836}" ,arg_value = 0.0},-- S-8TsM
                ...
                { CLSID	= "{6CEB49FC-DED8-4DED-B053-E1F033FF72D3}", arg_value = 0.5}, -- AIM-9M
				{ CLSID = "{AIM-9L}", arg_value = 0.5}, --AIM-9L NEU
				{ CLSID = "{AIM-9B}", arg_value = 0.5},--AIM-9B NEU
				{ CLSID = "{9BFD8C90-F7AE-4e90-833B-BFD0CED0E536}", arg_value = 0.5},--AIM-9P NEU
				{ CLSID = "{AIM-9P5}", arg_value = 0.5},--AIM-9P5 NEU
				{ CLSID = "{D5D51E24-348C-4702-96AF-97A714E72697}", arg_value = 0.0}, -- MER MK82 x 2 //NEU
				{ CLSID = "{BRU33_2*LAU10}", arg_value = 0.0}, -- MER LAU10 4xZuni 127mm HE Rockets x 2 //Bean
				{ CLSID = "{BRU33_2X_ROCKEYE}", arg_value = 0.0},--BRU33 Mk20 x2
				{ CLSID = "{BRU33_2X_MK-82}", arg_value = 0.0},--BRU33 MK82 slick x2 anstatt MER MK82x2
				{ CLSID = "{BRU33_2X_MK-82_Snakeye}", arg_value = 0.0}, --BRU33 MK82SE x2
				{ CLSID = "{F3EFE0AB-E91A-42D8-9CA2-B63C91ED570A}", arg_value = 0.0}, --  LAU10 4xZuni 127mm HE Rockets //Bean
				{ CLSID = "{7B34E0BB-E427-4C2A-A61A-8407CE18B54D}", arg_value = 0.0}, --  BRU42 3xMk-81 //Bean  
				{ CLSID = "{BRU42_2*MK81 RS}", arg_value = 0.0}, --  BRU42 2xMk-81 //Bean  
				{ CLSID = "{90321C8E-7ED1-47D4-A160-E074D5ABD902}", arg_value = 0.0}, --  Mk-81 //Bean  
				{ CLSID = "{00F5DAC4-0466-4122-998F-B1A298E34113}", arg_value = 0.0},--M117x1
				--{ CLSID = "{B06DD79A-F21E-4EB9-BD9D-AB3844618C93}",arg_value = 0.5,required = {{station = 11,loadout = {"{0519A264-0AB6-11d6-9193-00A0249B6F00}",arg_value = 0.0}}}},--AGM-88C
				{ CLSID = "{7210496B-7B81-4B52-80D6-8529ECF847CD}",arg_value = 0.5,required = {{station = 11,loadout = {"{0519A264-0AB6-11d6-9193-00A0249B6F00}",arg_value = 0.0}}}},--Kormoran
				{ CLSID = "{7B8DCEB4-820B-4015-9B48-1028A4195692}",arg_value = 0.5,required = {{station = 11,loadout = {"{0519A264-0AB6-11d6-9193-00A0249B6F00}",arg_value = 0.0}}}},--AGM-119
				--PTB
        ...
        pylon(5, 0, 0, 0, 0,
            ...
            {
				--{ CLSID = "{6CEB49FC-DED8-4DED-B053-E1F033FF72D3}", arg_value = 0.0, forbidden = 
				--{
				--{station = 6, loadout = {"{TER_9A_3*BDU-33}"}},
				--{station = 6, loadout = {"{RN-28}"}},
				--{station = 6, loadout = {"{RN-24}"}},
				--{station = 6, loadout = {"{BCE4E030-38E9-423E-98ED-24BE3DA87C32}"}},
				--{station = 6, loadout = {"{7A44FF09-527C-4B7E-B42B-3F111CFE50FB}"}},
				--{station = 6, loadout = {"{Mk82SNAKEYE}"}}} }, -- AIM-9M
				
				{ CLSID = "{AIM-9L}", arg_value = 0.0, forbidden = 
				{
				{station = 6, loadout = {"{TER_9A_3*BDU-33}"}},
				{station = 6, loadout = {"{RN-28}"}},
				{station = 6, loadout = {"{RN-24}"}},
				{station = 6, loadout = {"{BCE4E030-38E9-423E-98ED-24BE3DA87C32}"}},
				{station = 6, loadout = {"{7A44FF09-527C-4B7E-B42B-3F111CFE50FB}"}},
				{station = 6, loadout = {"{Mk82SNAKEYE}"}}} }, --AIM-9L NEU
				
				{ CLSID = "{AIM-9B}", arg_value = 0.0, forbidden = 
				{
				{station = 6, loadout = {"{TER_9A_3*BDU-33}"}},
				{station = 6, loadout = {"{RN-28}"}},
				{station = 6, loadout = {"{RN-24}"}},
				{station = 6, loadout = {"{BCE4E030-38E9-423E-98ED-24BE3DA87C32}"}},
				{station = 6, loadout = {"{7A44FF09-527C-4B7E-B42B-3F111CFE50FB}"}},
				{station = 6, loadout = {"{Mk82SNAKEYE}"}}} },--AIM-9B NEU
				
				{ CLSID = "{9BFD8C90-F7AE-4e90-833B-BFD0CED0E536}", arg_value = 0.0, forbidden =
				{
				{station = 6, loadout = {"{TER_9A_3*BDU-33}"}},
				{station = 6, loadout = {"{RN-28}"}},
				{station = 6, loadout = {"{RN-24}"}},
				{station = 6, loadout = {"{BCE4E030-38E9-423E-98ED-24BE3DA87C32}"}},
				{station = 6, loadout = {"{7A44FF09-527C-4B7E-B42B-3F111CFE50FB}"}},
				{station = 6, loadout = {"{Mk82SNAKEYE}"}}} },--AIM-9P NEU
				
				
				{ CLSID = "{AIM-9P5}", arg_value = 0.0, forbidden =
				{
				{station = 6, loadout = {"{TER_9A_3*BDU-33}"}},
				{station = 6, loadout = {"{RN-28}"}},
				{station = 6, loadout = {"{RN-24}"}},
				{station = 6, loadout = {"{BCE4E030-38E9-423E-98ED-24BE3DA87C32}"}},
				{station = 6, loadout = {"{7A44FF09-527C-4B7E-B42B-3F111CFE50FB}"}},
				{station = 6, loadout = {"{Mk82SNAKEYE}"}}} },--AIM-9P5 NEU
            }
        ),
		pylon(6, 0, 0, 0, 0,
        {
        use_full_connector_position = true,
			...
			{
				{ CLSID = "{Mk82SNAKEYE}",  arg_value = 0.0, forbidden = 
				{
				{station = 5, loadout = {"{AIM-9L}"}},	
				{station = 5, loadout = {"{AIM-9B}"}},
				--{station = 5, loadout = {"{6CEB49FC-DED8-4DED-B053-E1F033FF72D3}"}},
				{station = 5, loadout = {"{9BFD8C90-F7AE-4e90-833B-BFD0CED0E536}"}},
				{station = 5, loadout = {"{AIM-9P5}"}},
				{station = 7, loadout = {"{9BFD8C90-F7AE-4e90-833B-BFD0CED0E536}"}},
				{station = 7, loadout = {"{AIM-9P5}"}},
				{station = 7, loadout = {"{AIM-9L}"}},
				--{station = 7, loadout = {"{6CEB49FC-DED8-4DED-B053-E1F033FF72D3}"}},
				{station = 7, loadout = {"{AIM-9B}"}}} },

				{ CLSID = "{7A44FF09-527C-4B7E-B42B-3F111CFE50FB}",  arg_value = 0.0, forbidden = 
				{
				{station = 5, loadout = {"{AIM-9L}"}},	
				{station = 5, loadout = {"{AIM-9B}"}},
				--{station = 5, loadout = {"{6CEB49FC-DED8-4DED-B053-E1F033FF72D3}"}},
				...
				{ CLSID = "{BCE4E030-38E9-423E-98ED-24BE3DA87C32}",  arg_value = 0.0, forbidden = 
				{
				{station = 5, loadout = {"{AIM-9L}"}},	
				{station = 5, loadout = {"{AIM-9B}"}},
				--{station = 5, loadout = {"{6CEB49FC-DED8-4DED-B053-E1F033FF72D3}"}},
				...
				--[[{ CLSID = "{RN-24}",  arg_value = 0.0, forbidden = 
				{
				{station = 5, loadout = {"{AIM-9L}"}},	
				{station = 5, loadout = {"{AIM-9B}"}},
				{station = 5, loadout = {"{6CEB49FC-DED8-4DED-B053-E1F033FF72D3}"}},
				...
				{ CLSID = "{RN-28}",  arg_value = 0.0, forbidden = 
				{
				{station = 5, loadout = {"{AIM-9L}"}},	
				{station = 5, loadout = {"{AIM-9B}"}},
				--{station = 5, loadout = {"{6CEB49FC-DED8-4DED-B053-E1F033FF72D3}"}},
				...
				{ CLSID = "{TER_9A_3*BDU-33}", arg_value = 0.0, forbidden = 
				{
				{station = 5, loadout = {"{AIM-9L}"}},	
				{station = 5, loadout = {"{AIM-9B}"}},
				--{station = 5, loadout = {"{6CEB49FC-DED8-4DED-B053-E1F033FF72D3}"}},
