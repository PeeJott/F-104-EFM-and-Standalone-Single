...
VSN_F104S_AG =  {
		...
		Name 			= 'VSN_F104S_AG',--AG
		DisplayName		= _('F-104S Starfighter AG'),--AG
        Picture 		= "VSN_F104S.png",
        Rate 			= "50",
        Shape			= "VSN_F104S_AG",--AG	
        WorldID			=  WSTYPE_PLACEHOLDER, 
		input_profile_entry = 	"VSN_F104G_AG",
        
	shape_table_data 	= 
	{
		{
			file  	 	= 'VSN_F104S_AG';--AG
			life  	 	= 18; -- lifebar
			vis   	 	= 3; -- visibility gain.
			desrt    	= 'VSN_F104G-oblomok'; -- Name of destroyed object file name
			fire  	 	= { 300, 2}; 			-- Fire on the ground after destoyed: 300sec 2m
			username	= 'VSN_F104S_AG';--AG
	...
	Pylons =     {
        ...
        pylon(2, 0, -1.200, 0.000, -3.47000,
		 ...
		 pylon(3, 0, -0.881000, -0.504000, -2.624000,
            ...
            {
					-- F-104S
				{ CLSID = "{444BA8AE-82A7-4345-842E-76154EFCCA46}", arg_value = 0.5}, -- AGM-65D-LAU-117
				...
				{ CLSID = "{AIM-9B}", arg_value = 0.5},--AIM-9B NEU
				{ CLSID = "{B06DD79A-F21E-4EB9-BD9D-AB3844618C93}",arg_value = 0.5,required = {{station = 11,loadout = {"{0519A264-0AB6-11d6-9193-00A0249B6F00}"}}}},--AGM-88C
				{ CLSID = "{7210496B-7B81-4B52-80D6-8529ECF847CD}",arg_value = 0.5,required = {{station = 11,loadout = {"{0519A264-0AB6-11d6-9193-00A0249B6F00}"}}}},--Kormoran
				{ CLSID = "{7B8DCEB4-820B-4015-9B48-1028A4195692}",arg_value = 0.5,required = {{station = 11,loadout = {"{0519A264-0AB6-11d6-9193-00A0249B6F00}"}}}},--AGM-119
            }
        ),
