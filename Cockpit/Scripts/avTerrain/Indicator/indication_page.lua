dofile(LockOn_Options.script_path.."avTerrain/Indicator/definitions.lua")
...
function add_1000ft_profile_scribe(max_range_nm)
    ...
    scribe.controllers = {
        {"opacity_using_parameter", 0},
        {"change_color_when_parameter_equal_to_number", 1, 1, 1.0,0.1,0.0},
    }
...
for i=1,max_blobs do
    ...
    radar_blob.controllers = {
        ...
        {"change_color_when_parameter_equal_to_number", 3, 1, 1.0,0.1,0.0}
    }
