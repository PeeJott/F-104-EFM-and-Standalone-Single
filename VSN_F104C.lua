...
VSN_F104C =  {
		...
		Name 			= 'VSN_F104C',--AG
		DisplayName		= _('F-104C Starfighter'),--AG
	...
	Categories= {"{78EFB7A2-FD52-4b57-A6A6-3BF0E1D6555F}", "Interceptor",},
		...
		M_empty						=	6123,	-- kg  with pilot and nose load, F104 changed
		M_nominal					=	8981,	-- kg (Empty Plus Full Internal Fuel) F104 changed
		M_max						=	12791,	-- kg (Maximum Take Off Weight) F104 changed
	...
	Pylons =     {
        ...
        use_full_connector_position = true,
			...
			},
			{
				...
				{ CLSID = "LAU-115_2*LAU-127_AIM-9L",arg_value = 0.5},-- LAU-115 2xAIM-9L
				{ CLSID = "LAU-105_2*AIM-9P5",arg_value = 0.5},-- LAU-105 2xAim-9P5
			}
        ),
		pylon(7, 0, 0, 0, 0,
            {
